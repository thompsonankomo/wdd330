...
export default class Hikes {
    ...
    showOneHike(hikeName) {
        this.parentElement.innderHTML = "";
        const hike = this.getHikeByName(hikeName);
        this.parentElement.appendChild(renderOneHikeLight(hike));
    }

    addHikeListener() {
        const childrenArray = Array.from(this.parentElement.childNodes());
        childrenArray.forEach(hike => hike.addEventListener("ontouchend", showOneHike(hike.id)));
    }
